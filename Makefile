...
all: youtube-dl-loaddefs.el youtube-dl.elc youtube-dl-play.elc youtube-dl-view.elc

youtube-dl-loaddefs.el: youtube-dl.el youtube-dl-play.el youtube-dl-view.el
	$(EMACS) -batch -Q --eval \
